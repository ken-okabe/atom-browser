...
module.exports = {
  activate: function(state)
  {
    ...
    atom.workspaceView.command('atom-browser:left', function()
    {
      IO.log('atom-browser:left command');
      left();
    });
    atom.workspaceView.command('atom-browser:right', function()
    {
      IO.log('atom-browser:right command');
      right();
    });

    if (!atom.config.get('atom-browser.URL'))
    {
      alert('atom-browser is successfully installed!');
      atom.config.set('atom-browser.URL', 'http://google.com');
    ...
    /* atom.webRequest.onBeforeRequest.addListener(onBeforeRequest, function()
    {
      console.log('!!');
    });*/
    //-----
